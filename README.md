...
1. Visit the [Met Office DataHub](https://datahub.metoffice.gov.uk/). - Seems to come up as 403 Forbidden if you navigate straight from GitHub for some inexplicable reason, so paste the link into a new tab.
